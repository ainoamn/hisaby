  ...
  switch (bhd) {
    ...
    case "provision":
      return why
        ...
        : "تعذّر إنشاء مستخدم حسابي بعد الهوية. أعد المحاولة بعد لحظات.";
    case "exchange":
      return why && why !== "unknown"
        ? `تعذّر إكمال الدخول بعد الهوية (${why}). أعد المحاولة أو راجع سجلات API.`
        : "تعذّر إكمال الدخول بعد الهوية. أعد المحاولة أو راجع سجلات API.";
    case "error":
