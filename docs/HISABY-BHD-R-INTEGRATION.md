...
بعد حفظ مفتاح القراءة تتم **المزامنة تلقائياً كل 15 دقيقة بدون تدخل بشري**: العقارات، العناوين، الجهات، الفواتير، الحسابات الواردة والصادرة، التواريخ، والمدفوعات/المصروفات.
